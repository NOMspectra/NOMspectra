# Graphical user interface of nomspectra
...
Analysis can be performed only with spectra processed by this programm or by the *nomspectra* library; to work with other files, you need to bring the table headers in accordance with this library ('mass' as m/z, 'intensity' as Intensity, ',' as separator)
